...
(function(global, factory) {
    ...
    Parser.prototype.tokenize = function(src) {
        ...
        matchAll(src, START_TOKEN, function(open, index, src) {
            ...
            var match = src.slice(index + open.length)
                .match(TAGS[open]);
            match = (match ? match[0] : '');
    ...
    Parser.prototype.tokenHandler = function(open, inner) {
        ...
        if (type === 'directive') {
            ...
            extracted.src = extracted.src.replace(/\|\|/g, '~')
                .split('|');
            //put back || operators
            ...
            if (parts.length > 1) {
                var filters = parts.slice(1)
                    .map(this.parseFilter.bind(this));
    ...
    Parser.prototype.compileTag = function(str) {
        ...
        handler.call(this, str.slice(directive.length)
            .trim());
    };
    ...
    var tagHandlers = {
        ...
        'set': function(stmt) {
            var i = stmt.indexOf('=');
            var name = stmt.slice(0, i)
                .trim();
            var expr = stmt.slice(i + 1)
                .trim();
