var rule = {
   ...
   lazy:'js:if(/m3u8|mp4/.test(input)){input}else{let purl=request("https://svip.cygc.xyz/api/?key=3V0MI2GNT2FyGHfbrS&url="+input);input={jx:0,url:JSON.parse(purl).url,parse:0}}',
