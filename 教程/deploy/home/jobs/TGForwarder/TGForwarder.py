...
class TGForwarder:
    def __init__(self, api_id, api_hash, string_session, channels_groups_monitor, forward_to_channel,
                 limit, replies_limit, kw, ban, only_send, nokwforwards, fdown, download_folder, proxy, checknum, linkvalidtor, replacements, chaSession(string_session), api_id, api_hash)
        else:
    ...
    def replace_targets(self, message: str):
        ...
        for target_word, source_words in self.replacements.items():
            ...
            if isinstance(source_words, str):
                source_words = [sonnel_match, hyperlink_text):
        self.checkbox = {}
        ...
        if not proxy:
            self.client = TelegramClient(Stringurce_words]
            # 遍历每个需要替换的词
...
if __name__ == '__main__':
    ...
    replies_limit = 1
    kw = ['链接', '片名', '名称', '剧名','pan.quark.cn','115.com','anxia.com','alipan.com','aliyundrive.com','夸克云盘','阿里云盘','磁力链接']
    ban = ['预告', '预感', 'https://t.me/', '盈利', '即可观看','书籍','电子书','图书','软件','安卓','Android','课程','作品','教程','全书','名著','mobi','epub','pdf','PDF','抽奖','完整版','MP3','WAV','CD','音乐','专辑','资源','1995','1996','1997','1998','1999','2000','2001','2001','2002','2003','2004','2005','2006','2007','2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018','2019','2020','2021','2022','2023']
